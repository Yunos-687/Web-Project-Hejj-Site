...
<head>
    ...
    $(document).ready(function() {
        ...
        $.get('../php/retrieveManasek.php', { dateDay: 'العمرة' }, function(data) {
...
function checkCheckboxes() {
    ...
    $.get('../php/retrieveUserManasek.php', { userEmail: userEmail }, function(data) {
        ...
        if (isLastChecked) {
          var parameterValue = " تقبل الله عمرتك وجعلها عمرة مقبولة وسعياً مشكوراً "; // Replace "Your Parameter Value" with the value you want to pass
