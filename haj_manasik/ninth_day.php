...
<head>
    ...
    $(document).ready(function() {
        ...
        $.get('../php/retrieveManasek.php', { dateDay: 'التاسع' }, function(data) {
...
<body id="eighth">
    ...
    <div class="main-content">
      <h1 class="amiri-bold">اليوم التاسع (عرفة) من ذي الحجة</h1>
    ...
    <a href="tenth_day.php" style="display: inline-block;">
