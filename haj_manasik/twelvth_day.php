...
<head>
    ...
    $(document).ready(function() {
        ...
        $.get('../php/retrieveManasek.php', { dateDay: 'الثاني' }, function(data) {
...
<body id="eighth">
    ...
    <div class="main-content">
      <h1 class="amiri-bold">اليوم الثاني عشر من ذي الحجة</h1>
    ...
    <a href="eleventh_day.php" style="display: inline-block;margin-right: 70%;">
        <button type="button" class="btn btn-secondary btn-rounded" data-mdb-ripple-init>السابق</button>
    </a>
    <a href="thirteenth_day.php" style="display: inline-block;">
